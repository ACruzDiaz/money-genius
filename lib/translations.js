  ...
  es: {
    ...
    quiz: {
      configSlide: {
        ...
        capHumano: "Capital Humano (educación, experiencia.)",
      ...
      slide4: {
        ...
        q1: "Alto nivel socioeconómico. Ejecutivos, dueños de empresas, inversionistas (0-50)",
        q2: "Contactos puente. Personas que te abren paso a nuevos entornos (0-50)",
        q3: "Mismo nivel profesional. Colegas, compañeros de trabajo (0-50)",
        q4: "Vínculos familia / amigos cercanos (0-50)",
      },
      results: {
  ...
  en: {
    ...
    quiz: {
      ...
      slide4: {
        ...
        q1: "High socioeconomic level. Executives, business owners, investors (0-50)",
        q2: "Bridge connections. People who open doors to new environments (0-50)",
        q3: "Same professional level. Colleagues, coworkers (0-50)",
        q4: "Close family/friend ties (0-50)",
      },
      results: {
